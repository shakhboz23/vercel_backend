...
export class CourseController {
  ...
  getUsersByGroupId(@Param('group_id') group_id: number, @Query() { date, course_id, page }: { date: Date, course_id: number, lesson_id: number, page: string }, @Headers() headers: string) {
    const user_id = extractUserIdFromToken(headers, this.jwtService, true);
